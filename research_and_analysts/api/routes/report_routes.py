...
async def generate_report(request: Request, topic: str = Form(...)):
    ...
    return request.app.templates.TemplateResponse(
        request, "report_progress.html",
        {"topic": topic, "feedback": "", "thread_id": thread_id},
    )
...
async def submit_feedback(request: Request, topic: str = Form(...), feedback: str = Form(...), thread_id: str = Form(...)):
    ...
    return request.app.templates.TemplateResponse(
        request, "report_progress.html",
        {"topic": topic, "feedback": feedback, "doc_path": doc_path, "pdf_path": pdf_path, "thread_id": thread_id},
    )
